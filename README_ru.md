...
### Демонстрация
- Установите Arduino IDE и настройте её для работы с модулем [VBCore32G4](https://docs.vbcores.ru/docs/Hardware/vbcore) в соответствие с инструкцией в файле `Ru_Installation_guide.pdf`.
- Установите `rwip_gui` с помоощью файла `rwip_gui_1.0.0_install.exe`. Это стандартный мастер установки. Просто запустите его ис ледуйте инструкциям на экране.
- Прошейте микроконтроллер прошивкой `rwip_for_gui.ino`

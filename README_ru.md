...
- Установите **RWIP_GUI** с помоощью файла [rwip_gui_1.0.0_install.exe](./rwip_gui/rwip_gui_1.0.0_install.exe). Это стандартный мастер установки. Запустите его и следуйте инструкциям на экране.
- Прошейте микроконтроллер прошивкой [rwip_for_gui.ino](./Firmware/rwip_for_gui/)
...
- Можете сразу прошить микроконтроллер прошивкой [wheel_pendulum_practicum.ino](./Firmware/React_wheel_pendulum_practicum/)
